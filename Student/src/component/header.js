...
<nav className="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div className="navbar-brand-wrapper d-flex justify-content-center">
        <div className="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a className="navbar-brand brand-logo" href="#"><img src="../assests/images/l2.png" alt="logo"/></a>
          <a className="navbar-brand brand-logo-mini" href="#"><img src="../assests/images/l1.jpg" alt="logo"/></a>
        ...
        <ul className="navbar-nav mr-lg-2">
          <li className="nav-item nav-profile dropdown show"  onClick={() => handleClick(layoutRef)}>
            <a className="nav-link">
              <img src={"http://localhost:1350/public/"+user.img} alt="profile"/>
